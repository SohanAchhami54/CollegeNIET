  ...
  return (
    <>
     ...
     <div className='inline-flex flex-auto  bg-white/5  gap-1 whitespace-nowrap  justify-center items-center rounded-4xl  shadow-lg backdrop-blur-md p-2 border border-white/20'>
          ...
          <div className='flex flex-auto w-fit bg-white/5  gap-1   justify-center items-center rounded-4xl  shadow-lg backdrop-blur-md p-2 border border-white/20 mb-4 cursor-pointer transition-all duration-300 ease-in-out hover:scale-105 hover:z-10'>
                  {badgeIcon2}
                  <span className='text-white text-sm '>{badgeText2} </span>
          </div>
