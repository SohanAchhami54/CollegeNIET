     ...
     {/* Badge 1 */}
      {(badgeIcon || badgeText) && (
        <div className="inline-flex flex-auto bg-white/5 gap-1 whitespace-nowrap justify-center items-center rounded-4xl shadow-lg backdrop-blur-md p-2 border border-white/20">
          {badgeIcon}
          <span className="text-white text-lgx">{badgeText}</span>
        </div>
      )}

      {/* Badge 2 */}
      {(badgeIcon2 || badgeText2) && (
        <div className="group flex w-fit text-lg bg-white/5 gap-1 justify-center items-center rounded-4xl shadow-lg backdrop-blur-md p-2 border border-white/20 mb-4 cursor-pointer hover:text-blue-300">
          {badgeIcon2}
          <span className="text-white text-lg group-hover:text-blue-300">
            {badgeText2}
          </span>
        </div>
      )}
