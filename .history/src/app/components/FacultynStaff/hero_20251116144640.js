...
export default function FacultyHeroSection() {
  ...
  const facultyHeroContent = {
    badgeIcon: <AutoAwesomeIcon className="text-blue-400" />,  // Badge icon for the faculty
    ...
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 px-6 py-32 lg:py-40">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Centered Paragraph */}
          <div className="flex flex-col items-center justify-center text-center mb-12 px-4 sm:px-6 lg:px-12 max-w-2xl mx-auto">
