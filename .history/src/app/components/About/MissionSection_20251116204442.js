    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50 px-6 text-center">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition text-left">
             ...
             <div className="inline-flex items-center gap-2 px-4 py-4 rounded-lg bg-gradient-to-r from-green-500 via-pink-500 to-yellow-500 mb-4">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition text-left">
           ...
           <div className="inline-flex items-center gap-2 px-4 py-4 rounded-lg bg-gradient-to-r from-teal-400 via-yellow-500 to-red-500 bg-blend-multiply mb-4">
