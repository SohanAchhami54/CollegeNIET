  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 text-center text-white px-6">
      ...
      <div className="flex justify-center gap-4 flex-wrap">
        <button className=' rounded-full bg-white text-[#0b4c78] cursor-pointer hover:bg-blue-50 shadow-2xl hover:shadow-white/20 text-lg px-8 h-14 group'>
         <span className=''>Apply for 2026</span> 
         <EastIcon className='ml-2 h-5 w-5 group-translate-x-1 transition-transform' />
          </button>
          <button className=' rounded-full border border-white text-white backdrop-blur-500 cursor-pointer hover:text-white shadow-2xl hover:shadow-white/20 text-lg px-8 h-14 group flex items-center justify-center gap-2'>
