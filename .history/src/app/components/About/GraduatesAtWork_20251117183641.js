...
export default function GraduatesWorkAtSection() {
  ...
  const globalPartners = [
    "Cambridge University, UK","Mayo Clinic, USA","Nanyang Tech, Singapore",
    "AstraZeneca, USA","Wake Forest Institute, USA","Harbin Institute, China","UNSW, Australia",
    "Waterloo Institute, Ireland","Hannover Medical, Germany","IIT India",
  ];

  const privateHospitals = [
    "Grande Int'l Hospital", "Nepal Mediciti Hospital","Norvic Hospital","Lumbini Medical Hospital",
    "Chitwan Medical College", "Biratnagar Eye Hospital", "Birt Medical College","Dhulikhel Hospital",
    "Gautam Buddha Hospital","Universal College of Medical Sciences","National Kidney Center",
  ];

  const govtInstitutions = [
    "T.U. Teaching Hospital","Patan Academy of Science & Technology","Nepal Army Institute of Health Sciences","Armed Police Force Hospital",
    "B.P. Koirala Institute of Health Sciences", "B.P. Koirala Memorial Cancer Hospital","Kanti Children's Hospital",
    "Shahid Dharmabhakta Human Organ Transplant Centre","Ministry of Health and Population","National Public Health Laboratory",
  ];
