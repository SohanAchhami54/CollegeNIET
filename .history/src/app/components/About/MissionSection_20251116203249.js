    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50 px-6 text-center">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mb-4">
            <LanguageIcon className="h-10 w-10 text-[#b4c78] "  fontSize="large">  </LanguageIcon> 
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition text-left">
             ...
             <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 mb-4">
            <ModeStandbyIcon className="h-10 w-10 text-[#b4c78] "  fontSize="large">  </ModeStandbyIcon> 
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition text-left">
           ...
           <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 mb-4">
            <PeopleIcon className="h-10 w-10 text-[#b4c78] "  fontSize="large">  </PeopleIcon> 
