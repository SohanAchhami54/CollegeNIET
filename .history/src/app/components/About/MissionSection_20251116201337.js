    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50 px-6 text-center">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition">
          ...
          <h3 className={`text-left text-2xl font-semibold mb-3 ${graduateFont.className}`}>Our Mission</h3>
          <p className={`text-left text-lg text-gray-700 font-medium max-w-2xl mx-auto leading-relaxed ${robotoFont.className}`}>Empower students to drive innovation in biomedical technology, artificial intelligence, and computer systems.</p>
        </div>
