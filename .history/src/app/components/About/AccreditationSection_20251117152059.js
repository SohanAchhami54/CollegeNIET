...
//               <Typography variant="h5" className={`${graduateFont.className} text-gray-900 mb-4 `}>
//                 Purbanchal University
//               </Typography>

//               <Typography className={`${robotoFont.className} text-gray-600 leading-relaxed  `}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <Typography
              variant="body2"
              className={`text-[#0b4c78] ${robotoFont.className}`}
            >
              Accreditation & Partnerships
            </Typography>
          </Box>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          ...
          <Card
            elevation={0}
            className="rounded-2xl p-8 border border-gray-200 shadow-lg bg-white hover:shadow-xl transition-shadow duration-300"
          >
            <CardContent className="p-0">
              <Box className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#0b4c78] to-cyan-500 flex items-center justify-center mb-6">
                <ApartmentIcon className="text-white" fontSize="large" />
              ...
              <Typography
                variant="h5"
                className={`text-gray-900 mb-4 ${graduateFont.className}`}
              >
                Purbanchal University
              </Typography>

              <Typography
                className={`text-gray-600 leading-relaxed ${robotoFont.className}`}
              >
                NIET is affiliated with Purbanchal University for all BE and BTech programs.
                Our curriculum follows university standards and ensures accredited, 
                high-quality education.
