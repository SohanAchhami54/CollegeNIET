export const facultyData = [
  ...
  // Faculty 007
  {
    ...
    category: "teaching",
    image: "/guy.jpg",
    bio: "Niraj Basnet is a lecturer focused on web development, software engineering, and cloud computing. He has strong practical experience in full-stack development.",
    specialization: "Web Development, Software Engineering, Cloud Computing",
    courses: [
      { id: "course-017", name: "Web Development", code: "CS201", program: "B. Tech in AI", semester: "Semester II" },
      { id: "course-018", name: "Software Engineering", code: "CS301", program: "B. Tech in AI", semester: "Semester III" },
      { id: "course-019", name: "Cloud Computing", code: "CS502", program: "B. Tech in AI", semester: "Semester V" }
    ],
    education: [
      { degree: "M.Tech", field: "Software Engineering", institution: "IIT Roorkee", year: "2020", country: "India" },
      { degree: "B.E.", field: "Computer Engineering", institution: "Purbanchal University", year: "2018", country: "Nepal" }
    ],
    experience: [
      { position: "Lecturer", organization: "NIET", duration: "2021 - Present" },
      { position: "Software Engineer", organization: "Infosys", duration: "2018 - 2021" }
    ],
    contact: {
...
//         designation: 'Associate Professor',
//         department: 'Biomedical Engineering',
//         specialization: 'Biomedical Signal Processing and Sensors',
//         facultyType: 'part-time',
//         category: 'teaching',
//         order: 2,
//         image: '/girl.jpg',
//         courses: [
//         { id: 'bio201', code: 'BIO201', name: 'Biomedical Instrumentation', program: 'B.E. Biomedical' }
//         ],
//         contact: { email: 'priya.patel@niet.edu.np' }
//         },
// {
//         id: '2',
//         slug: 'priya-patel',
