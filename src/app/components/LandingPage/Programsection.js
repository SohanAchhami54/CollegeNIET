...
const Programsection = () => {
  return (
    <section className='w-[1400px] mx-auto h-[1000px] relative z-10 top-32 mb-60 px-6 lg:px-12'>
      {/* first container  */}
   ...
   {/* second container  */}
        ...
        <div className='grid lg:grid-cols-3 gap-6 lg:gap-8'>
          {/* card */}
         <div className='rounded-4xl overflow-hidden shadow-2xl hover:shadow-3xl  bg-red-300'>
          {/* Image  */}
            <div className='relative h-64 overflow-hidden'>
              <Image src='/BiomedicalLab.jpg' alt='BTechAI' width={600} height={400} className='w-full h-full object-cover ' />
