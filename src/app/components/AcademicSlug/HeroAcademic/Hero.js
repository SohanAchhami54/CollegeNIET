...
//             > */}
//             <div className='relative lg:col-span-5 h-60 sm:h-80 md:h-95 lg:h-125 xl:h-140 rounded-xl sm:rounded-4xl overflow-hidden shadow-2xl'>
...
//           <div className='mt-6 sm:mt-8 lg:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3
